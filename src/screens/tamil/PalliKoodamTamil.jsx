    ...
    <main className='h-full'>
      ...
      <section className='bg-[#6A8275] pb-5'>
        <div className="container p-4  mx-auto">
          ...
          <div className='flex flex-col mt-8'>
            ...
            <div className=" m-3 ">
              <h1 className='font-extrabold text-center text-[#432F4A] text-3xl sub-1'>பள்ளிக்கூடம்</h1>
            </div>
            <div className=" m-0.5 ">
      ...
      <section className='bg-[#C5D3AF] p-5'>
        <div className="container p-1  mx-auto">
          <div>
            <h3 className='flex flex-col text-center text-[15px] font-bold'>
              நம்மாழ்வார் வழியில் பயணத்தை தொடங்கிய நம் <span className='text-nowrap'>பல்லுயிர் களம் - அமைப்பு</span> பல்வேறு செயல் திட்டங்களை கொண்டிருந்தாலும் அதில் மிக முக்கியமானதாக   கருதுவது - பள்ளிகூடம் திட்டமே...</h3>
          </div>
        </div>
      </section>
      ...
      <section className='bg-[#6A8275] p-5'>
        <div className="container p-1  mx-auto">
          <div>
            <h3 className='flex flex-col text-center text-[15px] font-bold'>
              <span className='my-1'>பள்ளிக்கூடம்- இயற்கை விவசாய பயிற்சிகள் மற்றும் பகுதி சார்ந்த மரபு கலைகளையும் செயல் வழி பயிற்றுவிக்கிறது.</span>
              <span className='my-1'>விவசாயம் ஒரு தொழில் மட்டுமல்ல அது ஒரு வாழ்வியல் என்ற நம்மாழ்வார் அவர்களின் வார்த்தைகளையும் பள்ளிக்கூடம் பயிற்சிகளில் உணர்த்தி வருகிறோம்.</span>
            </h3>
          </div>
        </div>
      </section>
        ...
        <div className='flex flex-col bg-[#C5D3AF]  mt-5 p-2 md:p-5 rounded-md'>
          <div className='flex '>
            <div className='flex flex-col w-1/2 md:w-1/4'>
              <label className='my-3 text-gray-800 text-nowrap font-semibold' htmlFor="name">பெயர் </label>
              <label className='my-3 text-gray-800 text-nowrap font-semibold' htmlFor="address">முகவரி </label>
              <label className='my-3 text-gray-800 text-nowrap font-semibold' htmlFor="phoneno">அலைபேசி எண்</label>
              <label className='my-3 text-gray-800 text-nowrap font-semibold' htmlFor="email">மின்னஞ்சல்</label>
              <label className='my-3 text-gray-800  font-semibold' htmlFor="members">பங்குகொள்ளும் நபர்கள் எண்ணிக்கை</label>
              <label className='my-3 text-gray-800 text-nowrap font-semibold' htmlFor="days">பங்கேற்க விரும்பும் பயிற்சி</label>
            </div>
            <div className='flex flex-col w-1/2 md:w-3/4 px-5'>
              ...
              <input id='members' name='members' onChange={handleChange} value={input.members} className='my-5 w-[35%] mx-auto sm:my-2 bg-[#6A8275]  focus:outline-none rounded-lg px-2 py-1' type="number" />
            </div>
          </div>
          
          <div className=''>
            <div className='flex items-center m sm:my-2 mb-7  rounded-lg px-2 '>
              <select className='bg-[#6A8275] p-1 rounded  focus:outline-none' onChange={handleChange} name="days" id="days">
                <option className='bg-[#6A8275]' value="null">தேர்வு செய்ய</option>
                <option className='bg-[#6A8275] break-words' value="1">1 நாள் பயிற்சி</option>
                <option className='bg-[#6A8275] break-words' value="7">7 நாள் பயிற்சி</option>
                <option className='bg-[#6A8275] break-words' value="30">30 நாள் பயிற்சி</option>
              </select>
            </div>
            <label className='my- text-gray-800 font-semibold' htmlFor="feedback">பள்ளிகூடம் மேலும் சீர்பட உங்கள் கருத்துகள் :- </label>
