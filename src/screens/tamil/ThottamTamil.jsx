      ...
      <section className='bg-[#6A8275] p-5'>
        <div className="container p-1  mx-auto">
          <div>
            ...
            <h3 className='font-bold text-[15px] my-3 text-center'>இயற்கை வேளாண்மை - பாரம்பரிய அரிசி , பருப்பு ரகங்கள்  இன்று நமக்கு தெரிந்த இயற்கை விவசாயிகள் மூலம் பரவலாக கிடைக்கிறது.</h3>
